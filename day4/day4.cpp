...
int64_t SolutionDay4::prob1(std::string inputFile)
{
...
int64_t SolutionDay4::prob2(std::string inputFile)
{
    std::ifstream file(inputFile);
    auto content = readFile(file);
...
int main()
{
    ...
    std::unique_ptr<Solution> sol = std::make_unique<SolutionDay4>();
